class Zombie {
    constructor(x, y, type = 'normal') {
        ...
        if (type === 'normal') { this.radius = 15; this.speed = 1.8; this.hp = 4; this.color = '#1abc9c'; this.score = 10; }
        else if (type === 'runner') { this.radius = 12; this.speed = 4.0; this.hp = 2; this.color = '#e74c3c'; this.score = 20; }
        else if (type === 'tanker') { this.radius = 28; this.speed = 0.8; this.hp = 25; this.color = '#8e44ad'; this.score = 50; }
    }
    update() {
        if (Game.players.length > 0) {
            ...
            } else { this.x += (Math.random() - 0.5) * 0.5; this.y += (Math.random() - 0.5) * 0.5; }
        }
    }
    draw(ctx) {
