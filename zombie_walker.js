class Zombie {
    constructor(x, y, type = 'normal') {
        this.x = x; this.y = y; this.type = type; this.isAwake = false; this.angle = 0; 
        ...
        else if (type === 'tanker') { this.radius = 28; this.speed = 0.8; this.hp = 25; this.color = '#8e44ad'; this.score = 50; this.scale = 1.6; } 
    }
    update() {
        if (Game.players.length > 0) {
            ...
            if (this.isAwake) {
                ...
                this.x += (Math.random() - 0.5) * 0.5; this.y += (Math.random() - 0.5) * 0.5; this.angle += (Math.random() - 0.5) * 0.1; 
            }
        }
    }
    draw(ctx) {
