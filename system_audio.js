window.AudioSys = {
    sounds: {
        ...
        empty: "https://raw.githubusercontent.com/kenneynl/Shooter-Down/master/Audio/empty.ogg", // Bóp cò khi hết đạn
    ...
    play: function(name, volume = 0.5) {
        ...
        audio.volume = volume;
        audio.play().catch(e => {}); // Bỏ qua lỗi tự động play của trình duyệt lúc mới load
    }
};
